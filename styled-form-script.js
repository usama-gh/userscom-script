...
const styles = ` #parent-div{ position: relative; padding: 2rem 1rem; max-width:900px; margin-left: auto; margin-right: auto; } form { display:flex; flex-direction: column; row-gap: 0.675rem; /* 14px */ width: 100%; justify-content: center; } input, textarea, select {box-shadow: 0 1px 2px 0 rgb(0 0 0 / 0.05); font-size:0.875rem;border: 1px solid #ccc; padding: 15px 10px; border-radius: 10px; font-family: 'Inter', sans-serif; } ::placeholder { color: #9C9C9C; } #fileInputLabel{ color: #9C9C9C; font-family: 'Inter', sans-serif; font-size: 12px; } #submitButton { background-color: #4E4E4E; color: #FFFFFF; width: 100%; border-radius: 12px; border: none; font-weight:bold; font-size:0.875rem; font-family: 'Inter', sans-serif; cursor: pointer; padding: 15px 10px; transition: 0.3s; } #submitButton:hover { background-color: #191919; } #overlaySuccess { display: flex; justify-content: center; align-items: center; position: absolute; display: none; width: 100%; inset: 0px; transition: 0.3s; background-color: #EAFFEE; z-index: 2; cursor: pointer; height: 100%; top: 0; left: 0; right: 0; bottom: 0; } #successTextHeading { color: #8BB593; font-size: 42px; font-family: 'Inter', sans-serif; margin-top: 5px; letter-spacing:-2px; margin-bottom: 5px; } #successTextSubtitle { font-size: 14px; color: #8BB593; margin-top: 5px; margin-bottom: 20px; } #successButton{ border: solid 1px #8BB593; background-color: transparent; border-radius: 20px; color: #8BB593; padding: 5px 10px; cursor: pointer; } #overlayFailed { display: flex; justify-content: center; align-items: center; position: absolute; display: none; width: 100%; inset: 0px; transition: 0.3s; background-color: #FFEAEA; z-index: 2; cursor: pointer; height: 100%; top: 0; left: 0; right: 0; bottom: 0; } #failedTextHeading { color: #FF6666; font-size: 42px; font-family: 'Inter', sans-serif; margin-top: 5px; letter-spacing:-2px; margin-bottom: 5px; } #failedTextSubtitle { font-size: 14px; color: #FF6666; margin-top: 5px; margin-bottom: 20px; } #failedButton{ border: solid 1px #FF6666; background-color: transparent; border-radius: 20px; color: #FF6666; padding: 5px 10px; cursor: pointer; } #text{ text-align: center; font-size: 50px; color: white; display: flex; flex-direction: column; align-items: center; height: 100%; justify-content: center; } #drop-area { position:relative;font-size:0.875rem; color:#9c9c9c; border-radius: 10px;box-shadow: 0 1px 2px 0 rgb(0 0 0 / 0.05); border: 2px dashed #ccc; padding: 20px; text-align: center; } #image-preview { height: 100px; width: 200px; } #image-preview img{ height: 100px } #image-preview #iconContainer { right: 20px; } #extensionDiv { background: lightgray; display: flex; justify-content: center; border-radius: 10px; } #iconContainer { cursor: pointer; width: 20px; height: 20px; right: 30px; position: absolute; } .imagePicker { font-size: 10px; top:0px;left:0px; height:40px; position: absolute; opacity: 0; cursor: pointer; } `;
